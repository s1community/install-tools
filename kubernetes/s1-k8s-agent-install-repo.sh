...
HELM_RELEASE_VERSION=$(echo $S1_AGENT_TAG | cut -d "-" -f1) # ie: 23.4.2
...
#     printf "ie:${Green}  $0 \$S1_SITE_TOKEN \$S1_REPOSITORY_USERNAME \$S1_REPOSITORY_PASSWORD 23.4.2-ga debug \n${Color_Off}"
